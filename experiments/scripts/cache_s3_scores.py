...
CSV_PATH = NOTEBOOK_DIR / "data" / "validation_variants.csv"
FASTA_PATH = NOTEBOOK_DIR / "data" / "validation_proteins.fasta"
...
def main() -> int:
    ...
    for i, r in enumerate(df.itertuples(index=False)):
        ...
        pos1 = int(r.protein_pos) + 1  # CSV is 0-indexed; HGVS is 1-indexed
